...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	g := rg.Group("/appointments")
	{
		...
		g.POST("/:id/confirm", idapi.RequireRoles("admin", "staff"), h.Confirm)
		g.POST("/:id/complete", idapi.RequireRoles("admin", "staff"), h.Complete)
		g.POST("/:id/no-show", idapi.RequireRoles("admin", "staff"), h.MarkNoShow)
	}
}
