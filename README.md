# Axiom Clinic Appointment System
...
|----------|---------|-------------|
| `AXIOM_DATABASE_URL` | `postgres://clinic:clinic@localhost:5432/clinic?sslmode=disable` | PostgreSQL connection |
| `AXIOM_REDIS_URL` | `redis://localhost:6379` | Redis connection |
| `AXIOM_NATS_URL` | `nats://localhost:4222` | NATS JetStream connection |
| `AXIOM_JWT_SECRET` | *required* | JWT signing secret |
| `AXIOM_JWT_REFRESH_SECRET` | *required* | Refresh token secret |
| `AXIOM_LOG_LEVEL` | `info` | Log level |
| `AXIOM_PORT` | `8080` | HTTP port |
...
**Axiom** — Building reliable healthcare software  
