-- Baseline schema for the Clinic Appointment & Management Backend.
-- Implements SRS v1.0 section 7 (Data Requirements) and business rules BR-01..BR-09.
...
INSERT INTO roles (name) VALUES ('admin'), ('staff'), ('doctor'), ('patient')
